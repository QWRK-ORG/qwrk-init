...
describe("useNavigationStore", () => {
    beforeEach(() => {
        ...
        useNavigationStore.setState({
            breadcrumbs: [],
            setBreadcrumbs: (items) => useNavigationStore.setState({ breadcrumbs: items }),
            activeNavPath: null,
            setActiveNavPath: (path) => useNavigationStore.setState({ activeNavPath: path }),
            isMobileNavOpen: false,
            openMobileNav: () => useNavigationStore.setState({ isMobileNavOpen: true }),
            closeMobileNav: () => useNavigationStore.setState({ isMobileNavOpen: false }),
            toggleMobileNav: () =>
