...
describe("NavLinkItem", () => {
    ...
    it("renders with icon", () => {
        render(<NavLinkItem href='/home' label='Home' icon={<Home data-testid='home-icon' />} />)
    ...
    it("applies custom className", () => {
        render(<NavLinkItem href='/dashboard' label='Dashboard' className='custom-class' />)
    ...
    it("renders with tooltip", () => {
        render(<NavLinkItem href='/dashboard' label='Dashboard' tooltip='Navigate to dashboard' />)
    ...
    it("renders with custom aria-label", () => {
        render(<NavLinkItem href='/dashboard' label='Dashboard' ariaLabel='Go to dashboard' />)
    ...
    it("renders as external link when isExternal is true", () => {
        render(<NavLinkItem href='https://example.com' label='External' isExternal />)
