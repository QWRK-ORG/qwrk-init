...
describe("RoleBasedNav", () => {
    ...
    it("renders nothing when no items match user roles", () => {
        ...
        const { container } = render(<RoleBasedNav items={restrictedItems} userRoles={["user"]} />)
    ...
    it("applies custom className to the list", () => {
        render(<RoleBasedNav items={navItems} userRoles={["admin"]} className='custom-class' />)
    ...
    it("applies custom className to list items", () => {
        render(<RoleBasedNav items={navItems} userRoles={["admin"]} itemClassName='item-class' />)
    ...
    it("uses custom wrapper when provided", () => {
        ...
        render(<RoleBasedNav items={navItems} userRoles={["admin"]} wrapper={wrapper} />)
