...
it("renders description when provided", () => {
    render(<PageHeader title='Dashboard' description='View your analytics and reports' />)

    expect(screen.getByText("View your analytics and reports")).toBeInTheDocument()
})
...
it("applies custom className", () => {
    ...
    const rootDiv = screen.getByText("Dashboard").closest("div")?.parentElement?.parentElement
