export default function TestMobilePage() {
  return (
    <div className='container p-4'>
      ...
      <p className='mb-4'>
        This page is for testing the mobile navigation drawer. Resize your
        browser window to a mobile size (less than 768px) to see the hamburger
        menu in the top navigation. Click on it to open the mobile drawer.
      </p>
      <div className='p-4 border rounded-md'>
        ...
        <ol className='list-decimal pl-5 space-y-2'>
          ...
          <li>
            Verify that navigation items, logo, and actions appear in the drawer
          </li>
